...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: zG7_Dsu91v0n/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__zBfAk)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__mucJu)}>
            <div
              className={classNames(
                projectcss.all,
