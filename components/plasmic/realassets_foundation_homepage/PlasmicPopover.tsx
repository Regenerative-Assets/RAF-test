...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: dSPHML2uUc-_/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: MTp_lEgm5Ja_/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__fKOjp)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2___8YeHx)}
            label={"Open Popover"}
          />
        ),
