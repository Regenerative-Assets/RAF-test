...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: NLCwZEK-hMnq/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__izjTz)}>
        <div className={classNames(projectcss.all, sty.freeBox__erSmN)} />
      </div>
      {renderPlasmicSlot({
