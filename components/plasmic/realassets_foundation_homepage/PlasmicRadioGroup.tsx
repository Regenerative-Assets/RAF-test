...
import Radio from "../../Radio"; // plasmic-import: NLCwZEK-hMnq/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: 01Xj47ReFzyR/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox___9LypO)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__bpR7)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__jWc1Z)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__v17At)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
