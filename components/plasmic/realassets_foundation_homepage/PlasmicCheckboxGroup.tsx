...
import Checkbox from "../../Checkbox"; // plasmic-import: M6KjqQ3rgH_h/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: jm8JA08r-G60/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__mc69D)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__xhP6S)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__olRaP)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__gIbhh)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
