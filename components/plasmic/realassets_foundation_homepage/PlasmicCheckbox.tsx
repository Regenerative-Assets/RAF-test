...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: M6KjqQ3rgH_h/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: Xljajab2n-9v/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: 4AiXMpXbJgxo/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__nenat)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__sjrbu)}
            role={"img"}
          />
        ) : null}
      </div>
