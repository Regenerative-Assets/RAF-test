...
import SliderThumb from "../../SliderThumb"; // plasmic-import: zPyr-2pUpd26/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: xZHk8G_Na2Qp/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__cX3K)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__mjuKx)}>
        <div
