...
import MenuPopover from "../../MenuPopover"; // plasmic-import: CbjwFvIg8cYb/component
import MenuItem from "../../MenuItem"; // plasmic-import: zG7_Dsu91v0n/component
import MenuSection from "../../MenuSection"; // plasmic-import: wnMhEn5THBbE/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: kbG1Kkri5dGf/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__lNxXx)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
