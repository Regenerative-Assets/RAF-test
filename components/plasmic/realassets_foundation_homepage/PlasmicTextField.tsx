...
import Label from "../../Label"; // plasmic-import: G00ZRJ0WCLpd/component
import TextInput from "../../TextInput"; // plasmic-import: qgt7KlaYHyoH/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: N6DFoAyqpnx9/component
import Description from "../../Description"; // plasmic-import: EMu8C74u42nY/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: JgUBLdVOSu82/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__yYzvP, {
          [sty.freeBoxiconEnd__yYzvPzZ7X]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__yYzvPd6Szp]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__yYzvPyimjm]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__qANel, {
            [sty.freeBoxiconStart__qANelD6Szp]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__qANelyimjm]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__rpaw4)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__xDk3L, {
            [sty.freeBoxiconEnd__xDk3LzZ7X]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__xDk3Ld6Szp]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__b6Yox)}
                role={"img"}
              />
            ),
