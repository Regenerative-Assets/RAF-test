...
import sty from "./PlasmicButton.module.css"; // plasmic-import: W7iUbSpQ6pfE/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: RrJ-jCDXQg3b/icon
import ChevronDown2Icon from "./icons/PlasmicIcon__ChevronDown2"; // plasmic-import: q-9mRe6ovFrX/icon
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__q2Xbi, {
          [sty.freeBoxcolor_neutral__q2XbiWov95]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__q2XbiRGxKDF1Em]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__q2XbiOlSe]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__q2XbipTyve]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__q2XbiOdx7E]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__q2XbihdJ7A]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__q2XbidKQsz]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__q2XbiMaMch]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__q2XbidF1Em]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__tb2R3, {
            [sty.freeBoxcolor_neutral__tb2R3Wov95]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__tb2R3Wov95OomFc]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__tb2R32Rww2]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__tb2R3Odx7E]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__tb2R3DKQsz]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__tb2R3MaMch]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__tb2R3DF1Em]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__nUbbe)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__xzAUe, {
            [sty.freeBoxiconEnd__xzAUed3Wsu]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__xzAUeOdx7E]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__xzAUedKQsz]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__xzAUeMaMch]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__pKalk)}
                role={"img"}
              />
            ),
