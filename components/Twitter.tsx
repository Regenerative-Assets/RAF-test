...
import {
  PlasmicTwitter,
  DefaultTwitterProps
} from "./plasmic/realassets_foundation_homepage/PlasmicTwitter";
...
export interface TwitterProps extends DefaultTwitterProps {}

function Twitter_(props: TwitterProps, ref: HTMLElementRefOf<"svg">) {
